            ...
            <div class="p-6">
                <div class="flex justify-between items-center mb-6">
                    ...
                    <div class="flex space-x-4">
                        <a href="<?php echo e(route('admin.users.index')); ?>" class="text-sm text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white">
                            ...
                            <div>
                                ...
                                <div class="space-y-6">
                                    ...
                                    <div class="flex items-center space-x-4">
                                        ...
                                        <span class="font-medium text-gray-900 dark:text-white"><?php echo e($user->email); ?></span>
                                    </div>
                                    <div class="flex items-center space-x-4">
                                                ...
                                                <div class="flex items-center space-x-4">
                                                    <div class="flex-1">
                                                        <div class="flex items-center space-x-2">
                                                            <span class="text-gray-900 dark:text-white font-medium"><?php echo e($pet->name); ?></span>
                                                        ...
                                                        <div class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                                                            <span class="font-medium">Birth Date:</span> <?php echo e($pet->birth_date ? $pet->birth_date->format('M d, Y') : 'Unknown'); ?>
