            ...
            <div class="p-8">
                ...
                <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Manage and track all your veterinary
                            appointments</p>
                    </div>
                ...
                <!-- Filters -->
                <div
                    class="mb-8 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800/50 dark:to-gray-900/50 p-6 rounded-2xl border border-gray-100 dark:border-gray-700/50 shadow-sm">
                    <div class="flex items-center justify-between mb-5">
                        <h3
                            class="text-sm font-semibold text-gray-600 dark:text-gray-300 uppercase tracking-wider flex items-center">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                        ...
                        <div class="space-y-1.5">
                            <label for="status"
                                class="block text-xs font-medium text-gray-600 dark:text-gray-400 uppercase tracking-wider">Status</label>
                            <div class="relative">
                        ...
                        <div class="space-y-1.5">
                            <label for="date"
                                class="block text-xs font-medium text-gray-600 dark:text-gray-400 uppercase tracking-wider">Date
                                Range</label>
                            <div class="relative">
                        ...
                        <div class="space-y-1.5">
                            <label for="search"
                                class="block text-xs font-medium text-gray-600 dark:text-gray-400 uppercase tracking-wider">Search</label>
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                    <svg class="h-4 w-4 text-gray-400" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                ...
                                <thead class="bg-gray-50 dark:bg-gray-700/50">
                                    <tr>
                                        ...
                                        <th scope="col"
                                            ...
                                            Status</th>
                                        <th scope="col"
                                            class="px-6 py-3.5 text-right text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">
                                            Actions</th>
                                    </tr>
                                </thead>
                                <tbody
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $appointments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $appointment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="flex items-center">
                                                    <div
                                                        class="flex-shrink-0 h-9 w-9 rounded-lg bg-indigo-50 dark:bg-indigo-900/30 flex items-center justify-center mr-3">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                <div class="flex items-center justify-end space-x-2">
                                                    ...
                                                    <!--[if BLOCK]><![endif]--><?php if(in_array($appointment->status, ['pending', 'confirmed'])): ?>
