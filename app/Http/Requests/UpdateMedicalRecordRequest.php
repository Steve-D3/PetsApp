...
class UpdateMedicalRecordRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'veterinarian_profile_id' => 'sometimes|required|integer|exists:veterinarian_profiles,id',
            'appointment_id' => 'nullable|integer|exists:appointments,id',
            'record_date' => 'sometimes|required|date|before_or_equal:today',
            'chief_complaint' => 'sometimes|required|string|max:500',
            'history' => 'nullable|string',
            'physical_examination' => 'sometimes|required|string',
    ...
    public function messages(): array
    {
        return [
            ...
            'record_date.before_or_equal' => 'The record date must be today or in the past.',
            'chief_complaint.required' => 'The chief complaint field is required.',
            'physical_examination.required' => 'The physical examination field is required.',
