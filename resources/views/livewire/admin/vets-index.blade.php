...
<div class="py-6 px-4 sm:px-6 lg:px-8">
            ...
            @foreach ($vets as $vet)
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden transition-all duration-200 hover:shadow-md">
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <h3 class="text-lg font-medium text-gray-900 dark:text-white">
                                    <a href="{{ route('admin.vets.show', $vet->id) }}" class="hover:text-blue-600 dark:hover:text-blue-400">
                                        {{ $vet->user?->name ?? 'Unknown Vet' }}
                                    </a>
                                </h3>
                                <p class="text-sm text-blue-600 dark:text-blue-400 font-medium">
                                    {{ $vet->specialty ?? 'General Practitioner' }}
                                </p>
                            </div>
                        </div>
                            ...
                            <dl class="space-y-3">
                                <div class="flex items-center">
                                    ...
                                    <dd class="ml-3 text-sm text-gray-500 dark:text-gray-400">
                                        {{ $vet->license_number ?? 'License not specified' }}
                                    </dd>
                                </div>
                                <div class="flex items-center">
                                    <dt class="flex-shrink-0">
                                    ...
                                    <dd class="ml-3 text-sm text-gray-500 dark:text-gray-400">
                                        {{ $vet->clinic?->name ?? 'No clinic assigned' }}
                                    </dd>
                                </div>
                                @if($vet->user?->email)
                                <div class="flex items-center">
                    ...
                    <div class="bg-gray-50 dark:bg-gray-700/50 px-6 py-3 flex justify-end space-x-3 border-t border-gray-100 dark:border-gray-700">
                        <a href="{{ route('admin.vets.show', $vet->id) }}" class="inline-flex items-center px-3 py-1.5 border border-transparent text-xs font-medium rounded text-blue-700 bg-blue-100 hover:bg-blue-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 dark:bg-blue-900/30 dark:text-blue-300 dark:hover:bg-blue-800/50">
                            View
                        </a>
                        <a href="{{ route('admin.vets.edit', $vet->id) }}" class="inline-flex items-center px-3 py-1.5 border border-gray-300 dark:border-gray-600 text-xs font-medium rounded text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white dark:hover:bg-gray-600">
                            Edit
                        </a>
    ...
    @else
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-8 text-center">
            ...
            <div class="mt-6">
                <a href="{{ route('admin.vets.create') }}" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                    <svg class="-ml-1 mr-2 h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                        <path fill-rule="evenodd" d="M10 5a1 1 0 011 1v3h3a1 1 0 110 2h-3v3a1 1 0 11-2 0v-3H6a1 1 0 110-2h3V6a1 1 0 011-1z" clip-rule="evenodd" />
                    </svg>
                    New Veterinarian
