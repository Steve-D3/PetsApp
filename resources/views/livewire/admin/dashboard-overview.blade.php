                ...
                <div class="p-5">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="mt-1 text-2xl font-semibold text-gray-900 dark:text-white">{{ number_format(\App\Models\Appointment::count()) }}</p>
                        </div>
                ...
                <div class="p-5">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="mt-1 text-2xl font-semibold text-gray-900 dark:text-white">{{ number_format(\App\Models\User::where('role', 'vet')->count()) }}</p>
                        </div>
                ...
                <div class="p-5">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="mt-1 text-2xl font-semibold text-gray-900 dark:text-white">{{ number_format(\App\Models\User::where('role', 'owner')->count()) }}</p>
                        </div>
                ...
                <div class="p-5">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="mt-1 text-2xl font-semibold text-gray-900 dark:text-white">{{ number_format(\App\Models\Pet::count()) }}</p>
                        </div>
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4 flex-1 min-w-0">
                                        <p class="text-sm font-medium text-gray-900 dark:text-white truncate">
                                            {{ $appointment->pet->name ?? 'Pet' }} - {{ $appointment->veterinarian->name ?? 'Vet' }}
                                        </p>
