            ...
            <div
                ...
                <div
                    ...
                    <div
                        ...
                        <span class="truncate">Record ID: {{ $record->id }}</span>
                        <span class="hidden sm:inline mx-2">•</span>
                        <span
                            class="truncate">{{ \Carbon\Carbon::parse($record->record_date)->format('M d, Y') }}</span>
                    </div>
                </div>
                ...
                <div class="flex-1 overflow-y-auto p-4 sm:p-6">
                    <div class="space-y-6">
                                    ...
                                    <div class="mt-5 space-y-3 text-sm">
                                        ...
                                        <div class="flex items-center text-gray-700 dark:text-gray-300 group">
                                            ...
                                            <div>
                                                ...
                                                <div>{{ ucfirst($record->pet->gender) }}</div>
                                            </div>
                                        </div>
                                        @if ($record->pet->color)
                                            <div class="flex items-center text-gray-700 dark:text-gray-300 group">
                                ...
                                <div class="p-5">
                                    <div class="flex items-center space-x-4">
                                        ...
                                        <div class="min-w-0">
                                            ...
                                            <p class="text-sm text-gray-500 dark:text-gray-400">
                                                {{ $record->vet->specialization ?? 'General Practice' }}
                                            </p>
                                        </div>
                                    </div>
                                    <div class="mt-5 space-y-3 text-sm">
                                        @if($record->vet->user->phone)
                                            <div class="flex items-center text-gray-700 dark:text-gray-300 group">
                                                <div
                                                    class="p-1.5 rounded-md bg-blue-50 dark:bg-blue-900/20 text-blue-500 dark:text-blue-400 mr-3 group-hover:bg-blue-100 dark:group-hover:bg-blue-900/30 transition-colors">
                                                    <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24"
                                                ...
                                                <div>
                                                    ...
                                                    <a href="tel:{{ $record->vet->user->phone }}"
                                                        class="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 transition-colors">
                                                        {{ $record->vet->user->phone }}
                                                    </a>
                                                </div>
                                            </div>
                                        @endif
                                        @if($record->vet->user->email)
                                            <div class="flex items-center text-gray-700 dark:text-gray-300 group">
                                                <div
                                                    class="p-1.5 rounded-md bg-purple-50 dark:bg-purple-900/20 text-purple-500 dark:text-purple-400 mr-3 group-hover:bg-purple-100 dark:group-hover:bg-purple-900/30 transition-colors">
                                                    <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24"
                                                ...
                                                <div>
                                                    ...
                                                    <a href="mailto:{{ $record->vet->user->email }}"
                                                        class="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 transition-colors">
                                                        {{ $record->vet->user->email }}
                                                    </a>
                                                </div>
                                            </div>
                                        @endif
                        ...
                        <div
                            ...
                            @if(!empty(array_filter(array_column($sections, 'value'))))
                                <div class="p-5">
                                                ...
                                                <div
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="flex-shrink-0">
                                                            <div
                                                                class="h-10 w-10 rounded-lg {{ $section['color'] }} flex items-center justify-center">
                                                                <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                                                                    stroke="currentColor">
                                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                                                        stroke-width="1.8" d="{!! $section['icon'] !!}" />
                                                                </svg>
                                                            </div>
                                                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            ...
                                            <div class="flex">
                                                ...
                                                <div class="ml-3">
                                                    <h3 class="text-sm font-medium text-amber-800 dark:text-amber-200">
                                                        {{ $record->follow_up_required ? 'Follow-up Required' : 'No Follow-up Needed' }}
                                                    </h3>
                                                    @if($record->follow_up_required && $record->follow_up_date)
                                                        <div class="mt-2 text-sm text-amber-700 dark:text-amber-300">
                                                            <p class="flex items-center">
                                                                ...
                                                                {{ \Carbon\Carbon::parse($record->follow_up_date)->format('F j, Y') }}
                            ...
                            <div
                                ...
                                <div class="p-5">
                                    <div class="space-y-3">
                                        <a href="{{ route('medical-records.edit', ['pet' => $record->pet_id, 'record' => $record->id]) }}"
                        ...
                        @if ($treatments->count() > 0 || $vaccinations->count() > 0)
                                        ...
                                        <div class="flex items-center justify-between">
                                            ...
                                            @if($treatments->count() > 0)
                                                <span
                                                    ...
                                                    {{ $treatments->count() }}
                                                    {{ Str::plural('Treatment', $treatments->count()) }}
                                                </span>
                                            @endif
                                        </div>
                                    </div>
                                                        ...
                                                        <div class="flex items-start justify-between">
                                                            <div>
                                                                <div class="text-sm font-medium text-gray-900 dark:text-white">
                                                                    {{ $treatment->name }}</div>
                                                                @if($treatment->pivot && $treatment->pivot->notes)
                                                                    <p class="mt-1 text-sm text-gray-600 dark:text-gray-300">
                                                                        {{ $treatment->pivot->notes }}</p>
                                                                @endif
                                                            </div>
                                                            <button type="button"
                                        ...
                                        <div class="flex items-center justify-between">
                                            ...
                                            @if($vaccinations->count() > 0)
                                                <span
                                                    ...
                                                    {{ $vaccinations->count() }}
                                                    {{ Str::plural('Vaccine', $vaccinations->count()) }}
                                                </span>
                                            @endif
                                        </div>
                                    </div>
                                                                ...
                                                                <div class="mt-1.5 grid grid-cols-2 gap-x-4 gap-y-1 text-xs">
                                                                    @if($vaccination->pivot->administered_at)
                                                                        <div class="flex items-center text-gray-600 dark:text-gray-400">
                                                                            ...
                                                                            <span>Administered:
                                                                                {{ \Carbon\Carbon::parse($vaccination->pivot->administered_at)->format('M j, Y') }}</span>
                                                                        </div>
                                                                    @endif
                                                                    ...
                                                                    @if($vaccination->pivot->administered_by)
                                                                        <div
                                                                            ...
                                                                            <span>By: {{ $vaccination->pivot->administered_by }}</span>
                                                                        </div>
                                                                    @endif
                                                                </div>
