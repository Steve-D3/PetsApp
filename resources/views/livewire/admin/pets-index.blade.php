                    ...
                    @foreach ($pets as $pet)
                        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden transition-all duration-200 hover:shadow-md">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        <h3 class="text-lg font-medium text-gray-900 dark:text-white">
                                            <a href="{{ route('admin.pets.show', $pet->id) }}" class="hover:text-blue-600 dark:hover:text-blue-400">
                                                {{ $pet->name }}
                                            </a>
                                        </h3>
                                        <p class="text-sm text-indigo-600 dark:text-indigo-400 font-medium">
                                            {{ ucfirst($pet->type) }} • {{ $pet->breed ?? 'Mixed' }}
                                        </p>
                                    </div>
                                </div>
                                <div class="mt-6 border-t border-gray-100 dark:border-gray-700 pt-4">
                                    <dl class="space-y-3">
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <dd class="ml-3 text-sm text-gray-500 dark:text-gray-400">
                                                {{ $pet->weight ? $pet->weight . ' kg' : 'Weight not specified' }}
                                            </dd>
                                        </div>
                            ...
                            <div class="bg-gray-50 dark:bg-gray-700/50 px-6 py-3 flex justify-end space-x-3 border-t border-gray-100 dark:border-gray-700">
                                <a href="{{ route('admin.pets.show', $pet->id) }}" class="inline-flex items-center px-3 py-1.5 border border-transparent text-xs font-medium rounded text-blue-700 bg-blue-100 hover:bg-blue-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 dark:bg-blue-900/30 dark:text-blue-300 dark:hover:bg-blue-800/50">
                                    View
                                </a>
                                <a href="{{ route('admin.pets.edit', $pet->id) }}" class="inline-flex items-center px-3 py-1.5 border border-gray-300 dark:border-gray-600 text-xs font-medium rounded text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white dark:hover:bg-gray-600">
                                    Edit
                                </a>
