                            ...
                            <div>
                                ...
                                <div class="space-y-6">
                                    ...
                                    <div class="flex items-center space-x-4">
                                        ...
                                        <span
                                            class="font-medium text-gray-900 dark:text-white">{{ $user->email }}</span>
                                    </div>
                                    <div class="flex items-center space-x-4">
                                                ...
                                                <div class="flex items-center space-x-4">
                                                    <div class="flex-1">
                                                        <div class="flex items-center space-x-2">
                                                            <span
                                                                class="text-gray-900 dark:text-white font-medium">{{ $pet->name }}</span>
                                                            <span
                                                        ...
                                                        <div class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                                                            ...
                                                            {{ $pet->birth_date ? $pet->birth_date->format('M d, Y') : 'Unknown' }}
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
